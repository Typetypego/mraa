...
mraa_rockpis()
{
    ...
    mraa_rockpis_pininfo(b, 5,   12, (mraa_pincapabilities_t){1,1,0,0,0,1,0,0}, "I2C_SCL");
    ...
    mraa_rockpis_pininfo(b, 22,  71, (mraa_pincapabilities_t){1,1,0,0,0,0,0,0}, "I2S0_8CH_LRCK_TX");
